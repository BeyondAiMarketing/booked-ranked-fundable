...
const simple = <TPath extends string>(
  path: TPath,
...
const protectedPage = <TPath extends string>(
  path: TPath,
  Component: React.ComponentType,
  adminOnly = false,
) =>
...
const roofingPlaybookTripwireRoute = simple(
...
const adminAgentsRoute = protectedPage(
  "/admin-agents",
...
const socialContentGeneratorRoute = protectedPage(
  "/social-content-generator",
  SocialContentGeneratorPage,
);
const socialSchedulerRoute = protectedPage(
  "/social-scheduler",
  SocialSchedulerPage,
);
const socialEngagementAgentRoute = protectedPage(
  "/social-engagement-agent",
  SocialEngagementAgentPage,
);
const socialProofPipelineRoute = protectedPage(
  "/social-proof-pipeline",
  SocialProofPipelinePage,
);
const competitorIntelligenceRoute = protectedPage(
  "/competitor-intelligence",
  CompetitorIntelligencePage,
);
const socialLeadCaptureRoute = protectedPage(
  "/social-lead-capture",
  SocialLeadCapturePage,
);
const socialDemoFunnelRoute = protectedPage(
  "/social-demo-funnel",
  SocialDemoFunnelPage,
);
const whiteLabelHubRoute = protectedPage(
  "/white-label-hub",
  WhiteLabelHubPage,
  true,
);
...
const agencyOnboardingRoute = simple(
  "/agency-onboarding",
  AgencyOnboardingPage,
);
const agencyPartnersRoute = simple("/agency-partners", AgencyPartnersPage);
const agentWorkflowOSRoute = protectedPage(
  "/agent-workflow-os",
  AgentWorkflowOSPage,
  true,
);
const outreachAgentRoute = protectedPage(
  "/outreach-agent",
  OutreachAgentPage,
  true,
);
const openLeadLakeRoute = protectedPage(
  "/open-lead-lake",
  OpenLeadLakePage,
  true,
);
const scraperToolRoute = protectedPage("/scraper-tool", ScraperToolPage, true);
const csvLeadImportRoute = protectedPage(
  "/csv-lead-import",
  CsvLeadImportPage,
  true,
);
const gbpManagementRoute = protectedPage("/gbp-management", GbpManagementPage);
const landingPagesRoute = protectedPage(
  "/landing-pages",
  LandingPageBuilderPage,
);
const nicheWebsiteStudioRoute = protectedPage(
  "/website-studio",
  NicheWebsiteStudioPage,
  true,
);
const websiteAgentSettingsRoute = protectedPage(
  "/website-agent-settings",
  WebsiteAgentSettingsPage,
  true,
);
const nicheWebsitePreviewRoute = simple(
  "/preview/$previewId",
  NicheWebsitePreviewPage,
);
...
const healthDashboardRoute = protectedPage(
  "/health-dashboard",
...
const reputationInboxRoute = protectedPage(
  "/reputation-inbox",
  ReputationInboxPage,
);
const competitiveIntelRoute = protectedPage(
  "/competitive-intel",
  CompetitiveIntelPage,
);
const multiLocationRoute = protectedPage("/multi-location", MultiLocationPage);
const leadAttributionRoute = protectedPage(
  "/lead-attribution",
  LeadAttributionPage,
);
...
const autopilotDashboardRoute = protectedPage(
  "/autopilot-dashboard",
...
const brandKitTrialRoute = simple(
  "/brand-kit/$slug/trial",
  BrandKitTrialDashboardPage,
);
const adminBrandKitTrialsRoute = protectedPage(
  "/admin/brand-kit-trials",
  AdminBrandKitTrialsPage,
  true,
);
const adminBrfVoiceAgentRoute = protectedPage(
  "/admin/brf-voice-agent",
  AdminBrfVoiceAgentPage,
  true,
);
const adminTrialsRoute = protectedPage("/admin/trials", AdminTrialsPage, true);
const aiLeadIntelligenceRoute = protectedPage(
  "/ai-lead-intelligence",
  AILeadIntelligencePage,
  true,
);
const agentOrchestrationRoute = protectedPage(
  "/agent-orchestration",
  AgentOrchestrationPage,
  true,
);
const adminChatAgentRoute = protectedPage(
  "/admin-chat-agent",
  AdminChatAgentPage,
  true,
);
const adminVoicePreviewRoute = protectedPage(
  "/admin/voice-preview",
...
const replyInboxRoute = protectedPage(
  "/reply-inbox",
  ReplyIntelligenceInboxPage,
  true,
);
const smsAutopilotRoute = protectedPage(
  "/sms-autopilot",
  SmsAutopilotPage,
  true,
);
...
const outreachAnalyticsRoute = protectedPage(
  "/outreach-analytics",
  OutreachAnalyticsPage,
  true,
);
const public3dViewerRoute = simple("/view-3d/$modelId", Public3DViewerPage);
const adminVoiceManagerRoute = protectedPage(
  "/admin-voice-manager",
  AdminVoiceManagerPage,
  true,
);
const adminCommandCenterRoute = protectedPage(
  "/admin-command-center",
  AdminCommandCenterPage,
  true,
);
const outreachPipelineRoute = protectedPage(
  "/outreach-pipeline",
  OutreachPipelinePage,
  true,
);
const adminAIChatRoute = protectedPage("/admin-ai-chat", AdminAIChatPage, true);
const featureToggleRoute = protectedPage(
  "/admin/feature-toggles",
  FeatureTogglePage,
  true,
);
const integrationHealthRoute = protectedPage(
  "/admin/integration-health",
  IntegrationHealthPage,
  true,
);
const nicheAnalyticsRoute = protectedPage(
  "/admin/niche-analytics",
  NicheAnalyticsPage,
  true,
);
const adminAIProviderRoute = protectedPage(
  "/admin/ai-providers",
  AdminAIProviderPage,
  true,
);
const adminCollectionManagerRoute = protectedPage(
  "/admin/knowledge-collections",
  AdminCollectionManagerPage,
  true,
);
const adminRAGChatTesterRoute = protectedPage(
  "/admin/rag-tester",
  AdminRAGChatTesterPage,
  true,
);
const adminAgentWorkflowRunnerRoute = protectedPage(
  "/admin/agent-workflows",
  AdminAgentWorkflowRunnerPage,
  true,
);
const adminWorkflowLibraryRoute = protectedPage(
  "/admin/workflow-library",
  AdminWorkflowLibraryPage,
  true,
);
const adminN8NMigrationRoute = protectedPage(
  "/admin/n8n-migration",
  AdminN8NMigrationPage,
  true,
);
const adminN8NIntegrationDocsRoute = protectedPage(
  "/admin/n8n-integration-docs",
  N8NIntegrationDocsPage,
  true,
);
const adminAIUsageLogsRoute = protectedPage(
  "/admin/ai-usage-logs",
  AdminAIUsageLogsPage,
  true,
);
const adminVectorIndexRoute = protectedPage(
  "/admin/vector-index",
  AdminVectorIndexPage,
  true,
);
const adminClientAIManagerRoute = protectedPage(
  "/admin/client-ai-manager",
  AdminClientAIManagerPage,
  true,
);
const clientAskAIRoute = protectedPage("/ask-ai", ClientAskAIPage);
const clientAskAboutBusinessRoute = protectedPage(
  "/ask-about-business",
  ClientAskAboutBusinessPage,
);
const clientAIReportsRoute = protectedPage("/ai-reports", ClientAIReportsPage);
const clientAIRecommendationsRoute = protectedPage(
  "/ai-recommendations",
  ClientAIRecommendationsPage,
);
const clientUploadedDocsRoute = protectedPage(
  "/my-documents",
  ClientUploadedDocsPage,
);
const clientWorkflowAgentRoute = protectedPage(
  "/workflow-agent",
  ClientWorkflowAgentPage,
);
const adminMCPToolkitRoute = protectedPage(
  "/admin/mcp-toolkit",
  AdminMCPToolkitPage,
  true,
);
const accountBriefRoute = protectedPage(
  "/admin/account-brief",
  AccountBriefPage,
);
const composioToolConnectRoute = protectedPage(
  "/tools/connect",
  ComposioToolConnectPage,
);
const roofingAutomationsRoute = protectedPage(
  "/admin/roofing-automations",
  RoofingAutomationsPage,
  true,
);
const voiceAgentStudioRoute = protectedPage(
  "/voice-agent-studio",
  VoiceAgentStudioPage,
);
const contentCreationStudioRoute = protectedPage(
  "/content-creation-studio",
  ContentCreationStudioPage,
);
const localRankingIntelligenceRoute = protectedPage(
  "/local-ranking-intelligence",
  LocalRankingIntelligence,
);
const roofingCampaignRoute = protectedPage(
  "/admin/roofing-campaign",
  RoofingCampaignManager,
  true,
);
const roofingCampaignCommandCenterRoute = protectedPage(
  "/admin/roofing-command-center",
  RoofingCampaignCommandCenterPage,
  true,
);
const rooferCampaignRoute = protectedPage(
  "/roofer-campaign",
  RooferCampaignPage,
  true,
);
const demoBookingRoute = simple("/demo/$ctaToken", DemoBookingPage);
const masterAgentRoute = protectedPage(
  "/admin/master-agent",
  MasterAgentPage,
  true,
);
const contentOrchestratorRoute = protectedPage(
  "/content-orchestrator",
  ContentOrchestratorPage,
);
const brandOnboardingRoute = protectedPage(
  "/brand-onboarding",
  BrandOnboardingPage,
);
const socialContentCalendarRoute = protectedPage(
  "/social-content-calendar",
  SocialContentCalendarPage,
);
const platformContentRoute = protectedPage(
  "/platform-content",
  PlatformContentPage,
);
const performanceReviewRoute = protectedPage(
  "/performance-review",
  PerformanceReviewPage,
);
const rankedDispatchRoute = protectedPage(
  "/ranked-dispatch",
  RankedDispatchPage,
);
const localSEOAuditRoute = protectedPage("/local-seo-audit", LocalSEOAuditPage);
const reviewManagementRoute = protectedPage(
  "/review-management",
...
const routeTree = rootRoute.addChildren([
  ...
  roofingCampaignCommandCenterRoute,
  rooferCampaignRoute,
  demoBookingRoute,
