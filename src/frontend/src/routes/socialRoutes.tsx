...
export function buildSocialRoutes(rootRoute: AnyRoute, Protected: ProtectedRouteWrapper) {
  return [
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-media",
      component: () => <Protected><SocialMediaPage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-roi",
      component: () => <Protected><SocialROIDashboardPage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-content-generator",
      component: () => <Protected><SocialContentGeneratorPage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-scheduler",
      component: () => <Protected><SocialSchedulerPage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-engagement-agent",
      component: () => <Protected><SocialEngagementAgentPage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-proof-pipeline",
      component: () => <Protected><SocialProofPipelinePage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/competitor-intelligence",
      component: () => <Protected><CompetitorIntelligencePage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-lead-capture",
      component: () => <Protected><SocialLeadCapturePage /></Protected>,
    }),
    createRoute({
      getParentRoute: () => rootRoute,
      path: "/social-demo-funnel",
      component: () => <Protected><SocialDemoFunnelPage /></Protected>,
    }),
  ];
}
